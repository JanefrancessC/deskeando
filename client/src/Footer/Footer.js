...
import "./Footer.css";
import logo from "../Pages/images/darkBG-logo-02.svg";
							...
							<div className="col item social">
								<a href="#">
									...
									<svg
										...
										height="30"
										fill="currentColor"
										className="bi bi-facebook icon-white"
										viewBox="0 0 16 16"
									>
								...
								<a href="#">
									...
									<svg
										...
										height="30"
										fill="currentColor"
										className="bi bi-twitter icon-white"
										viewBox="0 0 16 16"
									>
								...
								<a href="#">
									...
									<svg
										...
										height="30"
										fill="currentColor"
										className="bi bi-linkedin icon-white"
										viewBox="0 0 16 16"
									>
